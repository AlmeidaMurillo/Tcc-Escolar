...
function Registro() {
  ...
  const handleSubmit = async (e) => {
    ...
    if (trimmedValue === "") {
      setErrorMessage("É necessário inserir um CPF para continuar.");
      return;
    }
    ...
    if (onlyNumbers.length !== 11) {
      setErrorMessage("O número deve ter 11 caracteres.");
      return;
    }
    ...
    try {
      ...
      localStorage.setItem("usuarioCPF", onlyNumbers);
      navigate("/registro/etapas");
    } catch {
      setErrorMessage("Erro ao verificar CPF. Tente novamente.");
    } finally {
      setLoading(false);
    }
  };
